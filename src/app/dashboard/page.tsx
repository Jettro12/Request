...
export default function Dashboard() {
  ...
  const [people, setPeople] = useState<User[]>([]); // Cambiado de any[] a User[]
    ...
    const loadPosts = async () => {
      try {
        ...
        if (selectedCareer !== "Todos los espacios") {
          params.append("careerSpace", selectedCareer);
        }
  ...
  const loadPeople = async () => {
    try {
      ...
      const params = new URLSearchParams();
      if (selectedCareer !== "Todos los espacios") {
        params.append("career", selectedCareer);
      }
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <div className="flex items-center space-x-2 text-sm text-gray-600">
                                ...
                                <span>• ★ {post.author.rating || "Nuevo"}</span>
                              </div>
                            </div>
                          </div>
